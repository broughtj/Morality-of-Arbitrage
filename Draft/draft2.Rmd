...
Coherence in de Finetti's definition of probability is the counterpart of the modern theory of no-arbitrage in finance.[^5] Interestingly, de Finetti took a very operational and economic approach to eliciting subjective probabilities. 

The axioms of probability which characterize any theory of probability arise logically from the
condition that subjective probabilities function as prices obeying coherency (i.e. the arbitrage free
conditions). 

Looking at problems of uncertainty as situations in which various contingent claims are traded is the key insight offered by the state-preference theory. 
...
- The morality of scholarship vs the morality of arbitrage is an example of a DBA.
