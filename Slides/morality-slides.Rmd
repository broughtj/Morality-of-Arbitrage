...
> *The task of the modern educator is not to cut down jungles but to irriage deserts. The right defense against false
> sentiments is to inculcate just sentiments. By starving the sensibility of our pupils we only make them easier prey to
> the propagandist when he comes. For famished nature will be avenged and a hard heart is no infallible protection
> against a soft head.*
...
> _"I would put the point more bluntly. The market for ideas is the market in which the intellectual conducts his trade. The explanation of the paradox is self-interest and self-esteem. Self-esteem leads the intellectuals to magnify the importance of their own market. That others should be regulated seems natural, particularly as many of the intellectuals see themselves as doing the regulating. But self-interest combines with self-esteem to ensure that, while others are regulated, regulation should not apply to them."_
...
```{r, echo=FALSE, out.width = "600px", out.height="490px"}
...
without leaving oneself open to a massive Dutch book. They are just two different examples of the very same thing!
...
>- Ben thinks that one of the problems is the lack of arbitragable positions. 
...
>- Once you start seeing the world this way you will see Dutch books everywhere. Especially on Facebook. 
